...
def act(rsurface, tick, keys, mb, mx, my):
    ...
    if tab != 2 and tab != 3:
        title_asset = ast.assets_data["title/title"]
    else:
        title_asset = ast.assets_data["about/licenses"]
    rsurface.blit(
        title_asset,
