...
def form_backgrounds(assets_data):
    return {
        ...
        "3": assets_data['bg/blood'],
        "4": assets_data['bg/cyber'],
        "5": assets_data['bg/green'],
        "6": assets_data['bg/red'],
        "7": assets_data['bg/rust'],
        "8": assets_data['bg/sand'],
        "9": assets_data['bg/thunder'],
        "10": assets_data['bg/rain'],
        "11": assets_data['bg/engine'],
        "12": assets_data['bg/jrises'],
        "13": assets_data['bg/wave'],
        "14": assets_data['bg/sohappy'],
        "15": assets_data['bg/deer'],
        "16": assets_data['bg/nothing'],
        "17": assets_data['bg/wire'],
        "18": assets_data['bg/palette_test']
    }
